...
public class Em_Registro_Ventas extends javax.swing.JFrame {
 String user;
   public static String user_update = "";
  DefaultTableModel model = new DefaultTableModel();
    public Em_Registro_Ventas() {
        initComponents();
         user = Login.user;
          setSize(626,555);
        setResizable(false);
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnBus, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 90, 110, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Em_Registro_Ventas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
