...
public class Em_Pro_Mostrar extends javax.swing.JFrame {

     String user;
   public static String user_update = "";
   DefaultTableModel model2 = new DefaultTableModel();
    public Em_Pro_Mostrar() {
        initComponents();
         user = Login.user;
          setSize(800,459);
        setResizable(false);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 400, 140, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Em_Pro_Mostrar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
