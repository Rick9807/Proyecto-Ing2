...
//Declararcion de la variables 
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnExit, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 290, 120, 50));

        jLabel2.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("jLabel2");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 230, 20));
...
//Boton de clientes
    private void btnClientesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnClientesActionPerformed
       dispose();
       //Redireccionar a añadir cliente

       new Ad_Clientes().setVisible(true);
    }//GEN-LAST:event_btnClientesActionPerformed
//Boton de generar ventas
...
//Boton de historial de ventas
    private void btnMostrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMostrarActionPerformed
        dispose();
        //Redireccionar a los registros de las ventas
