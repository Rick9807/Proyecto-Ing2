...
public class Em_Productos_Mostrar extends javax.swing.JFrame {

    String user;
   public static String user_update = "";
   DefaultTableModel model3 = new DefaultTableModel();
    
    public Em_Productos_Mostrar() {
        initComponents();
    user = Login.user;
          setSize(800,459);
        setResizable(false);
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnExit, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 390, 110, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Em_Productos_Mostrar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
